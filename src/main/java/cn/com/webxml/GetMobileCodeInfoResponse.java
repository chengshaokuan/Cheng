...
public class GetMobileCodeInfoResponse implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":getMobileCodeInfoResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
            ...
            try {
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("http://WebXml.com.cn/",
                            "getMobileCodeInfoResult").equals(reader.getName())) {
