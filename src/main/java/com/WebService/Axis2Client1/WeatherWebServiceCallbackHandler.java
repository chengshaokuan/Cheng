...
public abstract class WeatherWebServiceCallbackHandler {
    ...
    public void receiveResultgetSupportProvince(
        com.WebService.Axis2Client1.WeatherWebServiceStub.GetSupportProvinceResponse result) {
    }
    ...
    public void receiveResultgetSupportCity(
        com.WebService.Axis2Client1.WeatherWebServiceStub.GetSupportCityResponse result) {
    }
    ...
    public void receiveResultgetSupportDataSet(
        com.WebService.Axis2Client1.WeatherWebServiceStub.GetSupportDataSetResponse result) {
    }
    ...
    public void receiveResultgetWeatherbyCityNamePro(
        com.WebService.Axis2Client1.WeatherWebServiceStub.GetWeatherbyCityNameProResponse result) {
    }
    ...
    public void receiveResultgetWeatherbyCityName(
        com.WebService.Axis2Client1.WeatherWebServiceStub.GetWeatherbyCityNameResponse result) {
    }
