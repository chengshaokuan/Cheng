...
//        webSockets.add(this);
//        LogConfig.info("[websocket消息] 有新的连接，当前总数:{}",webSockets.size());
//    }
//    @OnClose
//    public void onClose(){
//        webSockets.remove(this);
//        LogConfig.info("[websocket消息] 连接断开，当前总数:{}",webSockets.size());
//    }
//    @OnMessage
//    public void onMessage(String message){
//        LogConfig.info("[websocket消息] 收到客户端发来的消息:{}",message);
//    }
//
//    public void sendMessage(String message){
//        for(WebSocket webSocket:webSockets){
//            LogConfig.info("[websocket消息] 广播消息,message={}",message);
//            try {
//                webSocket.session.getBasicRemote().sendText(message);
//            } catch (IOException e) {
//                LogConfig.warn("[websocket消息] 发送消息失败,e={}",e);
//            }
//        }
//    }
//}
