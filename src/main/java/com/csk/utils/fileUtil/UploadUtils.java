...
import com.csk.utils.Constants;
...
public class UploadUtils {
    ...
    /**
     * @Description: 获取操作HTML保存的图片
     * @param: filePath
     * @return: java.lang.String
     * @Author: Mr.Cheng
     * @Date: 17:56 2018/10/8
     */
    ...
    public static void uploadFile (String uploadUrl, String text, String savePath) {
        ...
        try {
            ...
            DataOutputStream dos = new DataOutputStream(httpURLConnection.getOutputStream());
            dos.writeBytes(twoHyphens + boundary + end);
            dos.writeBytes("Content-Disposition: form-data; name=\"LogConfig\"; filename=\"" + savePath + "\"" + end);
            dos.writeBytes(end);
    ...
    public static InputStream compressImg (FileItemStream fileStream, String suffix) {
        ...
        try {
            ...
            out.close();
//            ImageIO.write(buffImg, suffix, LogConfig);
